\subsection{Propojení s dash systémem a deaktivace pohybu}
...
Propojení mezi \texttt{PlayerController} a \texttt{PlayerDash} je implementováno pomocí volání metody \texttt{IsDashing()} v \texttt{PlayerDash}, která vrací aktuální stav dashe. Toto rozhodnutí se pak používá ve \texttt{FixedUpdate()} pro přeskočení standardních herních mechanik.