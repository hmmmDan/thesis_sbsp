\subsection{Wall-to-wall jump a rychlý přeskok mezi stěnami}

Další důležitou funkcí je rozpoznání \textit{wall-to-wall} skoku. Pomocí \texttt{Raycast} se detekuje, zda je na druhé straně hráče další stěna v dosahu. Pokud ano, použije se vyšší horizontální síla \texttt{wallToWallJumpForceX}, což umožňuje rychlejší přeskok mezi dvěma stěnami. Pokud ne, použije se nižší \texttt{singleWallJumpForceX}.
