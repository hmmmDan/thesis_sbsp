...
Ve třídě \texttt{PlayerController} je instance \texttt{PlayerControllerData} přidělena jako serializované pole pomocí atributu \texttt{[SerializeField]}. Toto pole se v editoru zobrazuje jako pole pro přetahování (drag and drop), kam lze umístit libovolný \texttt{ScriptableObject} asset vytvořený z třídy \texttt{PlayerControllerData}.
