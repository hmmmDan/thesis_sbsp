...
Dash se registruje jako input callback v metodě \texttt{OnDashInput()}, kde se volá \texttt{pd.TryDash()}. \texttt{pd} je reference na instanci \texttt{PlayerDash}, která se získá v \texttt{Awake()}. Metoda \texttt{IsDashing()} vrací aktuální stav dashe pro externí skripty, které potřebují vědět, zda hráč právě dashuje.
