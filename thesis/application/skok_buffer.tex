...
V \texttt{Update()} se pak kontroluje, zda je \texttt{lastPressedJumpTime > 0} a současně \newline \texttt{lastOnGroundTime > 0}. Pokud obě podmínky platí, provede se skok. Toto řešení eliminuje frustraci z toho, že hráč stiskne skok těsně před dopadem a skok se neprovede, protože hráč ještě není na zemi.