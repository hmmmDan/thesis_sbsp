\subsubsection{Horizontální pohyb a akcelerace}

Metoda \texttt{Run()} aplikuje horizontální pohyb pomocí \texttt{Lerp} interpolace, která zajišťuje plynulé zrychlení a zpomalování namísto okamžité změny rychlosti. Vzorec \newline \texttt{Mathf.Lerp(rb.linearVelocity.x, targetSpeed, Time.fixedDeltaTime * \newline accelRate)} postupně přesouvá aktuální rychlost k cílové rychlosti.
...
\end{lstlisting}
\lstcaption{Listing 4: Metoda Run pro horizontální pohyb}