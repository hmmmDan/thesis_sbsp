\subsection{Provádění skoku a nastavení fyzikálních parametrů}
...
Hodnota \texttt{jumpForce} se typicky pohybuje v rozmezí 10-20 v závislosti na nastavení gravitace a požadované výšky skoku. Správné nastavení této hodnoty je klíčové pro celkový herní pocit.
