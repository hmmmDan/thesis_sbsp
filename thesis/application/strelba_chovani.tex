\subsection{Chování projektilu po vystřelení}

Skript \texttt{BulletStripeShot.cs} se nachází na instanci projektilu a aktivuje se až po vystřelení. V \texttt{OnTriggerEnter2D()} se kontroluje, s jakým objektem projektil kolidoval.
