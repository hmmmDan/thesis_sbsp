\subsection{Metoda TryDash a kontrola podmínek}
...
Následně se kontroluje cooldown a stav dashe. Pokud běží cooldown (\texttt{dashCooldownTimer > 0}) nebo pokud je dash aktuálně aktivní, metoda se ukončí. Teprve pokud všechny tyto podmínky jsou splněny, pokračuje se k samotnému provedení dashe.
