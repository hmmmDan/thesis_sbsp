\subsection{Bounds a WorldToCell -- převod souřadnic}

Pro každou kolizi se počítají \texttt{Bounds} a převádějí se na souřadnice tilemap buněk pomocí \texttt{WorldToCell()}. \texttt{Bounds} representují ohraničení box collideru, zatímco \texttt{WorldToCell()} převádí world space souřadnice na grid space souřadnice tilemap.
