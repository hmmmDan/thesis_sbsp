...
\newpage
\input{application/playercontrollerdata_ucel.tex}
\input{application/playercontrollerdata_struktura.tex}
\input{application/playercontrollerdata_parametry.tex}
\newpage
\input{application/playercontrollerdata_vypocet.tex}
\input{application/playercontrollerdata_pouziti.tex}
...
\newpage
\input{application/playercontroller_main.tex}
\newpage
\input{application/playercontroller_input.tex}
\newpage
\input{application/playercontroller_zpracovani.tex}
\newpage
\input{application/playercontroller_pohyb.tex}
\newpage
\input{application/playercontroller_gravitace.tex}
\newpage
\input{application/playercontroller_rychlost.tex}
\input{application/playercontroller_kontrola.tex}
\newpage
\input{application/playercontroller_animace.tex}
\input{application/playercontroller_otoceni.tex}
\input{application/playercontroller_dash.tex}
...
\input{application/skok_coyote.tex}
\input{application/skok_buffer.tex}
\input{application/skok_provadeni.tex}
\newpage
\input{application/skok_cut.tex}
\input{application/skok_hang.tex}
\newpage
\input{application/skok_vstup.tex}
...
\input{application/dash_princip.tex}
\newpage
\input{application/dash_try.tex}
\newpage
\input{application/dash_smer.tex}
\newpage
\input{application/dash_movement.tex}
\newpage
\input{application/dash_cooldown.tex}
\input{application/dash_propojeni.tex}

\section{Wall jump a wall slide}
...
\newpage
\input{application/walljump_zaklad.tex}
\input{application/walljump_detekce.tex}
\input{application/walljump_slide.tex}
\newpage
\input{application/walljump_jump.tex}
\newpage
\input{application/walljump_walltowall.tex}
\input{application/walljump_propojeni.tex}
...
\newpage
\input{application/strelba_system.tex}
\input{application/strelba_smer.tex}
\input{application/strelba_vytvoreni.tex}
\input{application/strelba_naboje.tex}
\input{application/strelba_vystrel.tex}
\newpage
\input{application/strelba_respawn.tex}
\newpage
\input{application/strelba_chovani.tex}

\newpage
\section{Bowlingová koule}
...
\input{application/enemy_prehled.tex}
\input{application/enemy_pohyb.tex}
\newpage
\input{application/enemy_prodleva.tex}
\input{application/enemy_stun.tex}
\input{application/enemy_rust.tex}
\input{application/enemy_reset.tex}
\input{application/enemy_animace.tex}

\newpage
\section{Další skripty nepřítele}
...
\input{application/koleblivy_tile.tex}
\input{application/koleblivy_tick.tex}
\newpage
\input{application/koleblivy_limit.tex}
\input{application/koleblivy_bounds.tex}
\input{application/koleblivy_destroy.tex}
