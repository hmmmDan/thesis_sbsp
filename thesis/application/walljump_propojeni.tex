...
Po provedení wall jump se nastaví \texttt{isWallJumping} na true a odpočítává se timer \texttt{wallJumpTimer}. Dokud \texttt{isWallJumping} trvá, metoda \texttt{Run()} v \texttt{PlayerController} ignoruje horizontální vstup, takže hráč nemůže během wall jump reagovat na směrové tlačítko.
