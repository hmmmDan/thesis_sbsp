...
Sprite je grafický asset vytvořený ve specializovaném programu. Jedná se o komponenty, které uživatel uvidí ve výsledném produktu.
...
Prefab (prefabricated object) je předem vytvořený herní objekt uložený jako asset v projektu. Umožňuje vytvořit instanci (kopii) objektu přímo v kódu pomocí metody \texttt{Instantiate}. Prefaby se často používají pro projektil, nepřátele nebo jiné opakovaně vytvářené objekty ve hře.
